...
.. important::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  \-\-env GITREPOURL=https://github.com/124457235-myseneca/raspberrypi.git  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=37047  \-\-env VIPERVIZPORT=9005  \-\-env GITUSERNAME='124457235-myseneca'  \-\-env DOCKERUSERNAME='kasunsam'  \-\-env MQTTUSERNAME='ksathugoda.ca@gmail.com'  \-\-env KAFKACLOUDUSERNAME=''  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  maadsdocker/tml-solution-studio-with-airflow-amd64
...
.. list-table::
   ...
   * - \-\-env  SOLUTIONVIPERVIZPORT=44633
   ...
   * - \-\-env SOLUTIONEXTERNALPORT=40007
...
It can be accessed by entering: http://localhost:38121
...
.. important::
   http://localhost:44633/dashboard.html?topic=iot-preprocess,iot-preprocess2&offset=-1&groupid=&rollbackoffset=400&topictype=prediction&append=0&secure=1
...
.. important::
   http://localhost:44633/viperlogs.html?topic=viperlogs&append=0
...
.. list-table::
   ...
   * - **Parameter**
     - **Explanation**
   * - http://localhost:44633/<html file>
...
.. important::
   VIPERHOST_PRODUCE=127.0.1.1, VIPERPORT_PRODUCE=40007, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=36207, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=35967, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=43189, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=42549, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=34833, HPDEHOST=127.0.1.1, HPDEPORT=36387, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=41239

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-9413-project2-tss-kasuna-b4b4,solution_preprocessing_dag-project2-tss-kasuna-b4b4, python-preprocess-220-project2-tss-kasuna-b4b4,solution_preprocessing_dag-project2-tss-kasuna-b4b4, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
