[project2-tss-kasuna-b4b4] Operating Details
====================================

Generated On: 2024-10-22 19:58:52 UTC
...
.. important::
   ...
   **not be valid if your [project2-tss-kasuna-b4b4] container is NOT running**.

.. tip::
   You must have your [project2-tss-kasuna-b4b4] container running before connecting to the Visualization and Airflow URLs.
...
.. important::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  \-\-env GITREPOURL=https://github.com/124457235-myseneca/raspberrypi.git  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=38277  \-\-env VIPERVIZPORT=9005  \-\-env GITUSERNAME='124457235-myseneca'  \-\-env DOCKERUSERNAME='kasunsam'  \-\-env MQTTUSERNAME='ksathugoda.ca@gmail.com'  \-\-env KAFKACLOUDUSERNAME=''  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  maadsdocker/tml-solution-studio-with-airflow-amd64
...
.. important::
   kasunsam/project2-tss-kasuna-b4b4-amd64 (https://hub.docker.com/r/kasunsam/project2-tss-kasuna-b4b4-amd64)
...
.. important::
   docker run -d -p 49017:49017 -p 53447:53447 -p 38971:38971 \-\-env TSS=0 \-\-env SOLUTIONNAME=project2-tss-kasuna-b4b4 \-\-env SOLUTIONDAG=solution_preprocessing_dag-project2-tss-kasuna-b4b4 \-\-env GITUSERNAME=124457235-myseneca  \-\-env GITREPOURL=https://github.com/124457235-myseneca/raspberrypi.git \-\-env SOLUTIONEXTERNALPORT=49017  \-\-env CHIP=amd64 \-\-env SOLUTIONAIRFLOWPORT=53447  \-\-env SOLUTIONVIPERVIZPORT=38971 \-\-env DOCKERUSERNAME='kasunsam'  \-\-env EXTERNALPORT=38277 \-\-env KAFKACLOUDUSERNAME=''  \-\-env VIPERVIZPORT=9005 \-\-env MQTTUSERNAME='ksathugoda.ca@gmail.com' \-\-env AIRFLOWPORT=9000  \-\-env MQTTPASSWORD='<Enter mqtt password>'  \-\-env KAFKACLOUDPASSWORD='<Enter API secret>'  \-\-env GITPASSWORD='<Enter Github Password>'  \-\-env READTHEDOCS='<Enter Readthedocs token>'  kasunsam/project2-tss-kasuna-b4b4-amd64
...
.. list-table::
   ...
   * - \-\-env  SOLUTIONVIPERVIZPORT=38971
   ...
   * - \-\-env SOLUTIONEXTERNALPORT=49017
   ...
   * - \-\-env KAFKACLOUDPASSWORD
     - This is your API Secret from Confluent Cloud.
   * - kasunsam/project2-tss-kasuna-b4b4-amd64
...
It can be accessed by entering: http://localhost:53447
...
.. important::
   http://localhost:38971/dashboard.html?topic=iot-preprocess,iot-preprocess2&offset=-1&groupid=&rollbackoffset=400&topictype=prediction&append=0&secure=1
...
.. important::
   http://localhost:38971/viperlogs.html?topic=viperlogs&append=0
...
.. list-table::
   ...
   * - **Parameter**
     - **Explanation**
   * - http://localhost:38971/<html file>
...
[project2-tss-kasuna-b4b4] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/124457235-myseneca/raspberrypi/tree/main/tml-airflow/dags/tml-solutions/project2-tss-kasuna-b4b4
...
.. important::
   https://project2-tss-kasuna-b4b4.readthedocs.io
...
.. important::
   solution_preprocessing_dag-project2-tss-kasuna-b4b4
...
.. important::
   VIPERHOST_PRODUCE=127.0.1.1, VIPERPORT_PRODUCE=49017, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=35323, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=44361, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=33341, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=46737, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=33139, HPDEHOST=127.0.1.1, HPDEPORT=46767, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=42929

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-4901-project2-tss-kasuna-b4b4,solution_preprocessing_dag-project2-tss-kasuna-b4b4, python-preprocess-9562-project2-tss-kasuna-b4b4,solution_preprocessing_dag-project2-tss-kasuna-b4b4, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
